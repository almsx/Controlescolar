...
class Documento
{
	...
	function Documento($nro=0) 
	{
		if ($nro!=0)
		{
			...
			$result=$obj_documento->executeQuery("SELECT Alumnos.numerocontrol, Alumnos.nombrealumno, Alumnos.apellidopaterno, Alumnos.apellidomaterno, Doctos.docto1, Doctos.docto2, Doctos.docto3, Doctos.docto4, Doctos.docto5, Doctos.docto6, Doctos.docto7, Doctos.docto8, Doctos.docto9, Doctos.doctoa FROM Doctos INNER JOIN Alumnos ON Alumnos.id = Doctos.idAlumno WHERE id = $nro");  
			...
			$this->docto2=$row['docto3'];
			$this->docto2=$row['docto4'];
			$this->docto2=$row['docto5'];
			$this->docto2=$row['docto6'];
			$this->docto2=$row['docto7'];
			$this->docto2=$row['docto8'];
			$this->docto2=$row['docto9'];
			$this->docto2=$row['doctoa'];
		}
	}
	function getDocumentos() // este metodo podria no estar en esta clase, se incluye para simplificar el codigo, lo que hace es traer todos los clientes 
		{
			$obj_documento=new sQuery();
			$result=$obj_documento->executeQuery("SELECT Alumnos.numerocontrol, Alumnos.nombrealumno, Alumnos.apellidopaterno, Alumnos.apellidomaterno, Doctos.docto1, Doctos.docto2, Doctos.docto3, Doctos.docto4, Doctos.docto5, Doctos.docto6, Doctos.docto7, Doctos.docto8, Doctos.docto9, Doctos.doctoa FROM Doctos INNER JOIN Alumnos ON Alumnos.id = Doctos.idAlumno");
